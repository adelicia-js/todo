...
const App = () => {
  ...
  return (
    <div className="App">
      <h1>Welcome to demo Emumba Data Intelligence Marketplace Product</h1>
      <h2>This is the frontend of demo React App deployed using Amplify</h2>
